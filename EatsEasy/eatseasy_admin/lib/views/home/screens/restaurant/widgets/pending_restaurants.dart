...
class PendingRestaurants extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Fetch all pending restaurants at once (no pagination)
    final data = fetchRestaurants("Pending", 1, 1000); // Adjust the limit as necessary
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            ReusableText(
              text: "No pending restaurants found.",
              style: appStyle(14, kGray, FontWeight.normal),
            ),
            const SizedBox(height: 16),
            GestureDetector(
              onTap: () {
                // Trigger a refresh to check for pending restaurants
                refetch!();
              },
              child: Container(
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          print("Pending Restaurant: ${restaurant.title}");
