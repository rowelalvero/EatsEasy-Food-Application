...
import 'package:eatseasy_admin/views/home/screens/restaurant/widgets/wrapper_widget.dart';
...
class VerifiedRestaurants extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Fetch all restaurants at once (no pagination)
    final data = fetchRestaurants("Verified", 1, 1000); // Adjust the limit as needed
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          print("Restaurant: ${restaurant.title}");
