...
import '../../../../../models/payouts_model.dart';
...
class CompletedPayouts extends HookWidget {
  ...
  Widget build(BuildContext context) {
    // Fetch all completed payouts (without pagination)
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            ReusableText(
              text: "No completed payouts found.",
    ...
    // Display the list of all completed payouts without pagination
    return Padding(
