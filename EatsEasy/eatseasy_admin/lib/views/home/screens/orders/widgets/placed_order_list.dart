...
class PlacedOrders extends HookWidget {
  ...
  Widget build(BuildContext context) {
    // Fetch all placed orders (without pagination)
    final data = fetchOrders(1, 1000, "Placed"); // Adjust number for fetching all
    ...
    // Display the list of all placed orders without pagination
    return Padding(
