...
class DeliveringOrders extends HookWidget {
  ...
  Widget build(BuildContext context) {
    // Fetch all orders that are out for delivery (without pagination)
    final data = fetchOrders(1, 1000, "Out_for_Delivery"); // Adjust number to fetch all
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            ReusableText(
              text: "No delivering orders found.",
    ...
    // Display all the delivering orders
    return Padding(
