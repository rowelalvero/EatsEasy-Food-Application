...
class SoldOutFoodlist extends HookWidget {
  ...
  Widget build(BuildContext context) {
    // Fetch all sold-out foods at once (no pagination)
    final data = fetchFood(1, 1000, false); // Fetch a larger limit for all foods
    ...
    // Display the list of all sold-out foods without pagination
    return Padding(
