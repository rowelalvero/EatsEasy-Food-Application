...
import 'package:eatseasy_partner/common/utils/date.dart';
import 'package:eatseasy_partner/main.dart';
import 'package:eatseasy_partner/views/message/chat/index.dart';
import 'package:eatseasy_partner/views/message/controller.dart';
...
class MessageList extends GetView<MessageController> {
  ...
  Widget build(BuildContext context) {
    return Obx(
            ()=>CustomScrollView(
          slivers: [
            SliverPadding(padding: const EdgeInsets.symmetric(horizontal: 0, vertical: 0),
              sliver: SliverList(
