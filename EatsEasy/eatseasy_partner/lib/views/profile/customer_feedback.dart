...
class CustomerFeedback extends StatefulWidget {
  const CustomerFeedback({super.key, required this.restaurant});
...
class _CustomerFeedbackState extends State<CustomerFeedback> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: BackGroundContainer(child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            RatingBarIndicator(
              rating: double.tryParse(widget.restaurant!.rating.toString()) ?? 0.0,
