...
import 'package:eatseasy_rider/views/message/state.dart';
...
import '../../common/entities/mylocation.dart';
...
@override
  ...
  /*getUserLocation() async {
    try {
      ...
      String url ="https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=AIzaSyCBrZpYQFIWHQfgX4wvjzY5cC4JWDvu9XI";
