...
class ActiveOrders extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final hookResult = useFetchPicked("Delivering");
    ...
    return Container(
      ...
      width: width,
      color: kLightWhite,
      child: RefreshIndicator(color: kPrimary,
          onRefresh: () async {
            refetch();
          }, child: isLoading
        ...
        child: Column(
          ...
          children: [
            ...
            ReusableText(
              text: "Looks like there are no active orders right now. You're all caught up!",
              style: appStyle(14, kGray, FontWeight.normal),
            ),
            const SizedBox(height: 8),
            ReusableText(
              text: "Check back later or refresh to see if any new orders are available.",
              style: appStyle(12, kGray.withOpacity(0.6), FontWeight.normal),
            ),
            const SizedBox(height: 16),
            GestureDetector(
